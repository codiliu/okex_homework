...
async function main() {
    ...
    //储存部署信息在文件
    let artifactT20 = await artifacts.readArtifact("MyERC20");
    await writeAbiAddr(artifactT20, token.address, "MyERC20", network.name);
...
//npx hardhat run scripts/deploy.js --network oectestnet